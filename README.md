...
### Usage:
 ...
 - Execute
 `docker run -d --name TrafficServer -p 8080:8080 adamxiao/trafficserver`
...
`docker run -d --name TrafficServer -p 8080:8080 -v /home/adam/workspaces/trafficserver-docker/files/etc/trafficserver/:/etc/trafficserver/ trafficserver-docker:8`
